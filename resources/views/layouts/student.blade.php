...
<div class="h-screen flex overflow-hidden bg-slate-50" 
    ...
    <aside :class="{ 
        ...
        <div class="flex-1 px-2 py-2 overflow-y-auto space-y-0.5">
            <div x-show="!sidebarCollapsed" x-cloak class="px-2.5 pt-1.5 pb-0.5 text-[9px] font-bold uppercase tracking-wider text-slate-400">Learning</div>
            <div x-show="sidebarCollapsed" x-cloak class="my-1 border-t border-slate-100"></div>

            <a href="{{ route('student.dashboard') }}" 
               :title="sidebarCollapsed ? 'Dashboard' : ''"
               class="flex items-center rounded-lg text-xs font-semibold space-x-2.5 px-2.5 py-1.5 transition-all {{ request()->routeIs('student.dashboard') ? 'bg-amber-50 text-amber-800 shadow-2xs shadow-amber-100' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}"
            ...
            <a href="{{ route('student.my-courses') }}" 
               ...
               class="flex items-center rounded-lg text-xs font-semibold space-x-2.5 px-2.5 py-1.5 transition-all {{ request()->routeIs('student.my-courses') ? 'bg-amber-50 text-amber-800 shadow-2xs shadow-amber-100' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}"
               :class="sidebarCollapsed ? 'justify-center px-0 py-1.5' : 'space-x-2.5 px-2.5 py-1.5'">
            ...
            <a href="{{ route('student.assignments.index') }}" 
               ...
               class="flex items-center rounded-lg text-xs font-semibold space-x-2.5 px-2.5 py-1.5 transition-all {{ request()->routeIs('student.assignments.*') ? 'bg-amber-50 text-amber-800 shadow-2xs shadow-amber-100' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}"
               :class="sidebarCollapsed ? 'justify-center px-0 py-1.5' : 'space-x-2.5 px-2.5 py-1.5'">
            ...
            <a href="{{ route('student.payments') }}" 
               ...
               class="flex items-center rounded-lg text-xs font-semibold space-x-2.5 px-2.5 py-1.5 transition-all {{ request()->routeIs('student.payments') ? 'bg-amber-50 text-amber-800 shadow-2xs shadow-amber-100' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}"
               :class="sidebarCollapsed ? 'justify-center px-0 py-1.5' : 'space-x-2.5 px-2.5 py-1.5'">
                <i data-lucide="receipt" class="w-4 h-4 text-sky-500 flex-shrink-0"></i>
                <span x-show="!sidebarCollapsed" x-cloak class="truncate">Order History</span>
            </a>

            <div x-show="!sidebarCollapsed" x-cloak class="pt-2.5 px-2.5 pb-0.5 text-[9px] font-bold uppercase tracking-wider text-slate-400">Explore</div>
            <div x-show="sidebarCollapsed" x-cloak class="my-1 border-t border-slate-100"></div>

            <a href="{{ route('courses.index') }}" 
               :title="sidebarCollapsed ? 'Explore Courses' : ''"
               class="flex items-center rounded-lg text-xs font-semibold space-x-2.5 px-2.5 py-1.5 text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-colors"
               :class="sidebarCollapsed ? 'justify-center px-0 py-1.5' : 'space-x-2.5 px-2.5 py-1.5'">
                <i data-lucide="compass" class="w-4 h-4 text-amber-400 flex-shrink-0"></i>
                <span x-show="!sidebarCollapsed" x-cloak class="truncate">Browse Catalog</span>
            </a>
            ...
            <a href="{{ route('certificate.verify') }}" 
               ...
               :class="sidebarCollapsed ? 'justify-center px-0 py-1.5' : 'space-x-2.5 px-2.5 py-1.5'">
                ...
                <span x-show="!sidebarCollapsed" x-cloak class="truncate">Verify Certificate</span>
            </a>
        </div>
